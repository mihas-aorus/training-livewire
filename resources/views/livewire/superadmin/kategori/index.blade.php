    ...
    <div class="content-wrapper">
        ...
        <script>
            $wire.on('closeCreateModal', () => {
                ...
                Swal.fire({
                title: "Tambah Data Kategori Berjaya",
                text: "Rekod Kategori berjaya disimpan.",
                icon: "success"
                });
            });
        </script>
        ...
        <script>
            $wire.on('closeEditModal', () => {
                ...
                Swal.fire({
                title: "Update Data Kategori Berjaya",
                text: "Rekod Kategori berjaya disimpan.",
                icon: "success"
                });
            });
        ...
        <script>
            $wire.on('closeDeleteModal', () => {
                ...
                Swal.fire({
                title: "Hapus Data Kategori Berjaya",
                text: "Rekod Kategori berjaya dihapus.",
                icon: "success"
                });
            });
        </script>
